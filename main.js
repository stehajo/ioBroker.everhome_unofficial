...
async function main() {
	...
	// adapter.config:
	adapter.log.info("config open: " + adapter.config.open);
	adapter.log.info("config close: " + adapter.config.close);
	adapter.log.info("config stop: " + adapter.config.stop);
